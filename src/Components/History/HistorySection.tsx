      ...
      <div className="relative z-10">
        ...
        <div className="flex justify-center items-center mb-8 md:mb-10 px-4">
          <div className="flex items-center gap-2 md:gap-3">
            <img src={quoteIcon} alt="quote" className="w-6 md:w-9 h-auto object-contain -translate-y-4" />
            <h2 className="text-xl md:text-2xl lg:text-3xl font-bold text-[#3A5F7D] whitespace-nowrap">
              تاريخ الأعمال والجوائز
            </h2>
            <img src={quoteIcon} alt="quote" className="w-6 md:w-9 h-auto object-contain translate-y-4 transform scale-[-1]" />
          </div>
        </div>
