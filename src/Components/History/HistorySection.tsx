...
const HistorySection= ({data}) => {
  ...
  return (
    <section className="relative py-12 md:py-16 bg-[#F5F5F5] overflow-hidden w-full px-[100px] xxl:px-[154px]">
      <div className="relative z-10">
        
        <SectionTitle title={'تاريخ الأعمال والجوائز'}/>

        <div className="w-full flex flex-col items-center ">
          <div className="hidden md:flex flex-col items-center pl-[3px] mb-[10px]">
          ...
          <div className="hidden md:flex flex-col items-center pl-[3px] mt-[10px]">
            <div className="w-[3px] h-12 bg-primary"></div>
            <div className="w-3 h-3 md:w-4 md:h-4 bg-primary rounded-full"></div>
          </div>
        </div>
