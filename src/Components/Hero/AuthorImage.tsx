...
export function AuthorImage({ data }: { data: AuthorData | undefined }) {
  return (
    <aside
      ...
      className="relative w-[200px] h-[250px] sm:w-[200px] sm:h-[250px] md:w-[250px] md:h-[320px] lg:w-[35%] lg:max-w-[400px] lg:h-[480px] xl:h-[550px] bg-cover bg-no-repeat rounded-t-full shrink-0 overflow-hidden"
    >
      <div
      ...
      <img
        ...
        className="w-[90%] absolute bottom-0 left-0 z-10"
      />
    </aside>
  );
}