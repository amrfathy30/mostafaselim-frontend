...
import { TopQuotesIcon,BottomQuotesIcon } from '../../icons/single-book-page-icons'; 
...
const DescriptiveInfoSection: React.FC<Props> = ({ mainTitle, sections,showTopQuote = false, showBottomQuote = false}) => {
  return (
