      ...
      {showShareButton && book && (
        <div className="mt-10 px-2">
          <button 
              ...
              className="w-full bg-[#008dff] hover:bg-[#0070cc] text-white font-bold py-3.5 rounded-lg flex flex-row-reverse items-center justify-center gap-3 transition-all active:scale-95 shadow-md font-expo"
          >
