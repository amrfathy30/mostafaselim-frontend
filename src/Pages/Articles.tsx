...
import ArticleSkeleton from "../Components/works/ArticleSkeleton";
  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 md:max-w-[768px] lg:max-w-[1280px] xl:max-w-[1440px] xxl:max-w-[1600px]">
        ...
        {loading ? (
          <>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 xl:gap-6 xxl:gap-[31px] lg:px-20 md:px-5 pb-20">
              {[...Array(9)].map((_, index) => (
              ...
              <div className="flex justify-center items-center mb-8 xxl:mb-[50px]">
                <div className="flex items-center gap-2 relative">
                  ...
                  <h1
                    data-aos="zoom-in"
                    data-aos-delay="150"
                    className="text-xl md:text-2xl xl:text-3xl xxl:text-[40px] font-bold text-primary">
                    المقالات
                  </h1>
                  <img
                    data-aos="fade-left"
